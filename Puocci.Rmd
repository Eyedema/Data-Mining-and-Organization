...
```{r, echo=FALSE, fig.align = "center", dpi=400}
par(mfrow=c(1,3))
k1 <-kmeans(dataset,4, nstart=50,iter.max = 15 )
plot(jitter(dataset$Voto_test,3) ~ jitter(dataset$Voto_medio, 3), col=k1$cluster)
k1 <-kmeans(dataset,4, nstart=50,iter.max = 15 )
plot(jitter(dataset$Voto_Matematica,3) ~ jitter(dataset$Voto_medio, 3), col=k1$cluster)
k1 <-kmeans(dataset,4, nstart=50,iter.max = 15 )
plot(jitter(dataset$Voto_test,3) ~ jitter(dataset$Voto_Matematica, 3), col=k1$cluster)
```